    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Movie movie) {
            ...
            if (context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                ...
                ivPoster.setBackgroundResource(R.drawable.flicks_backdrop_placeholder);
            } else {
                imageUrl = movie.getPosterPath();
                ivPoster.setBackgroundResource(R.drawable.flicks_movie_placeholder);
                transformation = new RoundedCornersTransformation(30, 0);
            }
            Glide.with(context).load(imageUrl).transform(transformation).override(Target.SIZE_ORIGINAL).into(ivPoster);
        }
    }
}
